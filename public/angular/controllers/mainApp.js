...
angular.module('articleApp').controller('ArticleListController', ['$scope', '$http', '$location', '$resource', '$routeParams', '$route', function ArticleListController($scope, $http, $location, $resource, $routeParams, $route) {
        var self = this;
       ...
       // self.status = '';
        ...
        self.getArticles = function () {
            var GetArticles = $resource('/articles/getArticles');
            GetArticles.get({}, function (success) {
